...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_LAND = 1.0, 				-- the lowest % the slider can go for land units
	TRADE_CAP_LOW_LIMIT_NAVAL = 1.0, 			-- the lowest % the slider can go for naval units
